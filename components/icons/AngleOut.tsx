...
export default function AngleOut({
  size = 16,
  color = "currentColor",
}: ComponentProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill={color} className="bi bi-arrows-angle-contract" viewBox="0 0 16 16">
